...
#save(myres0, file = "output/lgg-da/lgg10fDA_feb2.RData")
load("~/Reproduce-tPPMx/output/lgg-da/lgg10fDA_feb2.RData")
...
table(matchRTComp[which(labels1 == 5),9])#higher the better response
table(matchRTComp[which(labels1 == 6),9])#higher the better response
table(matchRTComp[which(labels1 == 7),9])#higher the better response
table(matchRTComp[which(labels1 == 8),9])#higher the better response
table(matchRTComp[which(labels1 == 9),9])#higher the better response
table(matchRTComp[which(labels1 == 10),9])#higher the better response

g1 <- orp[which(labels1==1)]
g2 <- orp[which(labels1==2)]
g3 <- orp[which(labels1==3)]
g4 <- orp[which(labels1==4)]
g5 <- orp[which(labels1==5)]
g6 <- orp[which(labels1==6)]
g7 <- orp[which(labels1==7)]
g8 <- orp[which(labels1==8)]
g9 <- orp[which(labels1==9)]
g10 <- orp[which(labels1==10)]
...
table(matchRTComp[which(labels2 == 5),9])#higher the better response
table(matchRTComp[which(labels2 == 6),9])#higher the better response
table(matchRTComp[which(labels2 == 7),9])#higher the better response
table(matchRTComp[which(labels2 == 8),9])#higher the better response
table(matchRTComp[which(labels2 == 9),9])#higher the better response
table(matchRTComp[which(labels2 == 10),9])#higher the better response

g1 <- orp[which(labels2==1)]
g2 <- orp[which(labels2==2)]
g3 <- orp[which(labels2==3)]
g4 <- orp[which(labels2==4)]
g5 <- orp[which(labels2==5)]
g6 <- orp[which(labels2==6)]
g7 <- orp[which(labels2==7)]
g8 <- orp[which(labels2==8)]
g9 <- orp[which(labels2==9)]
g10 <- orp[which(labels2==10)]
...
fclu <- ppmxct_fixed(y = data.matrix(Y), X = data.frame(X), Xpred = NULL,
       Z = data.frame(Z),Zpred = NULL, asstreat = trtsgn, #treatment,
       PPMx = 0, cohesion = 1, kappa = c(1, 20, 10, 1), sigma = c(0.01, .59, 6),
       similarity = 2, consim = 2, similparam = vec_par, calibration = 2,
       coardegree = 2, modelpriors, update_hierarchy = T, hsp = F,
